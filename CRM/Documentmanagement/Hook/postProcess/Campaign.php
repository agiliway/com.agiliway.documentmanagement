...
class CRM_Documentmanagement_Hook_postProcess_Campaign extends CRM_Documentmanagement_Attachments {
  ...
  public function __construct(&$form) {
    ...
    $this->entityId = $this->form->getVar('_campaignId') ?: $this->getLastId();
  }
